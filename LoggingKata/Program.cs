...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Kyle: exception = null - so no input added 

            if (lines.Length ==1)
                { logger.LogWarning("Only 1 line found"); };
            ...
            // Kyle: added Geolocation and then GeoCoordinate
            // Kyle: github Getcoordinate had usage info (github.com/ghuntley/geocoordinate/tree/master)
            
            
            
            double distanceInitial = 0;
            ...
            for (int i = 0; i < locations.Length; i++)
            {
                ...
                for (int j = 0; j < locations.Length; j++)
                {
                    ...
                    distanceInitial = corA.GetDistanceTo(corB);
